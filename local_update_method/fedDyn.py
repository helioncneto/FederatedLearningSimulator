...
class LocalUpdate(object):
    """
    Local training for FedDYN
    Local objective function consists of local loss, local gradient regularization, l2 regularization
    """
    ...
    def train(self, net, delta=None, user=None, malicious=False):
        model = net
